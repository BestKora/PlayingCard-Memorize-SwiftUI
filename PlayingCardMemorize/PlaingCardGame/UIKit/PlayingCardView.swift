...
//  PlayingCard
//
//  Created by CS193p Instructor on 10/11/17.
...
class PlayingCardView: UIView {
 ...
 //   var isFaceUp: Bool = true { didSet { setNeedsDisplay(); setNeedsLayout() } }
    ...
    override func draw(_ rect: CGRect) {
        let roundedRect = UIBezierPath(roundedRect: bounds, cornerRadius:0.0 /*cornerRadius*/)
     //   roundedRect.addClip()
...
// let font = UIFont.preferredFont(forTextStyle: .body).withSize(scaledSize)
